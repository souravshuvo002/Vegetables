...
import com.sourav.vegetables.Activity.CheckOutActivity;
...
public class YourReviewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadReviews() {
        ...
        Call<Result> call = service.getUserReviews(USER_ID);
